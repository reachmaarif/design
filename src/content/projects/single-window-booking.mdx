...
<br/>
The existing booking funnel is a replica of the B2C booking channel of redbus.in which is a happy flow for consumers who would book one or few tickets for a bus service. It was not optimized for counter bookings. A new system which could help the counter operator book tickets in a easy to use environment at a much faster pace was imperative. Designing an efficient system with work flows designed to help operators/agents choose different services and add passenger details as quickly as possible was the challenge.
