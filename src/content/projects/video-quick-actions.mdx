...
<h6 class="font-PPBold">Customer wants:</h6>
...
<h6 class="font-PPBold">Business needs:</h6>
...
<Container variant="transparent" eyebrow="role" title="ship. future proof.">
    <div class="max-w-2xl">
        ...
        <Columns columns={3}>
            ...
            <h6 class="font-PPBold">Framework</h6>
            ###### 
            Collaborated with website and Image Quick Action teams to define the Video Quick Actions framework.

            </div>
            <div class="px-5 py-6 rounded-md bg-base-100">
            <h6 class="font-PPBold">E2E workflow</h6>            
            ######
            Get leadership buy-ins and Design the E2E workflow for each tool and final sign off after multiple design crits.

            </div>
            <div class="px-5 py-6 rounded-md bg-base-100">
            <h6 class="font-PPBold">Insights + Next steps</h6>
            ######
